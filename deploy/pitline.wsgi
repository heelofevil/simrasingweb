...
# reload marker: 2026-08-12-field-work-fix-v3
_HOME = "/home/a1302688"
...
_INTERP = os.path.join(_VENV_ROOT, "bin/python3")

if os.path.isfile(_INTERP) and sys.executable != _INTERP:
...
def _fixed_wsgi(environ, start_response):
    ...
    for prefix in ("/site.wsgi", "/app.wsgi", "/pitline.wsgi", script):
